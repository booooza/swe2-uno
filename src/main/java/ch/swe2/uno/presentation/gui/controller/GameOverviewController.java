		...
		if (selectedCard != null) {
			...
			try {
				...
				if (selectedCard.getType() == CardType.WILD) {
					...
					mainApp.setState(
							client.request(Request.Command.PLAY, mainApp.getPlayerName(), selectedCard, unoButton.isSelected(), chosenColor)
					);
				} else {
					mainApp.setState(
							client.request(Request.Command.PLAY, mainApp.getPlayerName(), selectedCard, unoButton.isSelected())
					);
				}
			} catch (Exception e) {
